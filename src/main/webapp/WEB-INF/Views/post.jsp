...
function appendData(data){
    ...
    $(".post__block__detail").append("<label>Tác giả: <a href='" + hrefLocation + "/profile/" + data.author.username + "'>" + data.author.username + "</a></label>");
